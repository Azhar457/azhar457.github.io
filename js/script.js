...
const PROJECTS = [
  { title:'JarsLab — Homelab & Self-Hosted Solutions', description:'Landing page profesional untuk jasa instalasi homelab dan self-hosted applications. Dark cyberpunk theme dengan terminal animation dan glassmorphism.', tech:['HTML','CSS','JavaScript','SEO'], url:'https://jarslab.dpdns.org', image:'assets/jarslab.png', category:'web', stats:'Deployed: Mar 2026' },
  { title:'PAI Profesi Guru', description:'Media pembelajaran interaktif PAI dengan asesmen diri, materi terstruktur per bab, dan download referensi PDF.', tech:['HTML','CSS','JavaScript','Responsive'], url:'https://paiprofesi.netlify.app', image:'assets/paiprofesi.png', category:'web', stats:'7 Bab Materi + Asesmen' },
  { title:'Akhlak Terpuji — Media PAI', description:'Platform pembelajaran Pendidikan Agama Islam fokus pada materi akhlak terpuji untuk SD/MI dengan navigasi berbasis kelas.', tech:['HTML','CSS','JavaScript'], url:'https://pai-akhlakterpuji.netlify.app', image:'assets/pai-akhlak.png', category:'web', stats:'Materi Kelas 2 & 3' },
  { title:'Kopalan Nusantara Studio', description:'Company profile landing page untuk creative studio dengan layanan UI/UX design, web development, branding, dan photography.', tech:['HTML','CSS','JavaScript','UI/UX'], url:'https://kopalanusantaratest.netlify.app', image:'assets/kopalan.png', category:'web', stats:'6 Layanan + Portfolio' },
